...
tags:
  ...
  - pytorch
  - tutorial
description: An example-driven, incremental tutorial introduction to PyTorch.
---
**Note: This tutorial was made using PyTorch v0.4.0 (May 30th, 2018).** I'm not sure how compatible it is with later versions.

[Take me to the github!](https://github.com/joshualelon/Pytorch-Tutorial)
...
## 1. Bare Minimum Model<a id="one"></a>
...
## 2. Basic Linear Regression Model<a id="two"></a>
...
## 3. Calculating Our Gradient (of our linear layer wrt our input)<a id="three"></a>
...
## 4. Calculating The Loss Function <a id="four"></a>
...
## 5. Recalculating/Updating Our Weights (using gradient of loss wrt weights) <a id="five"></a>
...
## 6. Updating Our Weights More Than Once (i.e. doing step 3-6 a few times aka "epochs") <a id="six"></a>
...
## 7. Making Our Epochs Only Use A Subset Of The Data (i.e. a "minibatch") <a id="seven"></a>
...
## 8. Changing Our Model from Linear Regression to Neural Network (to make it fit the data better) <a id="eight"></a>
...
- https://www.deeplearningbook.org - _The_ deep learning book
...
## 9. Abstracting our Neural Network into its PyTorch class (i.e. making it more maintainable and less messy) <a id="nine"></a>
...
## 10. Changing Our Input From Arbitrary Vectors To Images <a id="ten"></a>
...
![Sample CIFAR-10 images](https://i.imgur.com/sample-cifar10.png)
...
![Test images](https://i.imgur.com/test-images.png)

## 11. Adding A Convolutional Layer <a id="eleven"></a>
...
![Convolutional test results](https://i.imgur.com/conv-test.png)
...
## 12. Adding A Pooling Layer <a id="twelve"></a>
...
![Pooling test results](https://i.imgur.com/pooling-test.png)
...
## 13. Do Some Final Optimizations (i.e. making our first sigmoid a "ReLU", and adding more layers) <a id="thirteen"></a>
...
![Final optimization test results](https://i.imgur.com/final-test.png)
...
## 14. Bask... in the glory that is our newly created Convolutional Neural Network (CNN)! <a id="fourteen"></a>
...
![Final CNN results](https://i.imgur.com/final-cnn.png)
